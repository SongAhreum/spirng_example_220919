...
<div class="container">
	...
	<form method="post" action="/lesson04/ex02/add_student">
		...
		<div class="form-group">
			...
			<input type="text" id="phoneNumber" name="phoneNumber" class="form-control col-3" placeholder="예)01011112222">
		</div>
		<div class="form-group">
			<label for="email">이메일</label>
			<input type="text" id="email" name="email" class="form-control col-3" placeholder="abdc@naver.com">
		</div>
		<div class="form-group">
